...
export default function Index(){
    ...
    return(
            ...
            <View style={{backgroundColor:'white'}}>
                <Input borderWidth={2} borderColor={"black"} margin={15} size={'$4'} placeholder={'Chercher'} style={{fontFamily:'Futura-Medium'}} borderRadius={30} autoCapitalize="none" backgroundColor={"white"} onChangeText={setRecherche} returnKeyType='default'/>
                <XStack padding={4} justifyContent='center' marginBottom={15} gap='$11'>
